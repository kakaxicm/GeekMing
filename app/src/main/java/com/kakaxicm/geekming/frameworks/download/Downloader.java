package com.kakaxicm.geekming.frameworks.download;
...
public class Downloader {
	...
	public void downFile(String url, HashMap<String, String> headers, DownloadProcessor downloadProcessor, boolean isGet)
		...
		try {
			...
			if (DownloadConfig.CURRENT_NETWORK_STATE_TYPE == DownloadConfig.NETWORK_STATE_CMWAP
					|| DownloadConfig.CURRENT_NETWORK_STATE_TYPE == DownloadConfig.NETWORK_STATE_CTWAP) {
			...
			HttpConnectionParams.setConnectionTimeout(params, DownloadConfig.HTTP_CONNECTION_TIMEOUT);
			HttpConnectionParams.setSoTimeout(params, DownloadConfig.HTTP_SO_TIMEOUT);
			HttpConnectionParams.setSocketBufferSize(params, DownloadConfig.HTTP_SOCKET_BUFFER_SIZE);
